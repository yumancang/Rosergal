...
{   
    ...
    public function __construct()
    {
        ...
        $this->slaveDb = \App\Library\Framework\Database\DB::getInstance("slave");
        ...
        $this->masterDb = \App\Library\Framework\Database\DB::getInstance("master");
    }
...
$db = \App\Library\Framework\Database\DB::getInstance("default");


$goods = new \App\Library\Model\Mysql\Goods();
...
$slaveDb = \App\Library\Framework\Database\DB::getInstance("slave");
...
$masterDb = \App\Library\Framework\Database\DB::getInstance("master");
